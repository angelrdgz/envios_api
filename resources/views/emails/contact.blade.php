																	...
																	<tr>
																		<td class="mcnImageContent" valign="top"
																			...
																			<img align="center" alt=""
																				src="https://gallery.mailchimp.com/0cadaae1b677ac715ccc000e1/images/b51412df-9284-4484-8b17-aaab8b5c1529.png"
																				width="281"
																				style="max-width:281px; padding-bottom: 0; display: inline !important; vertical-align: bottom;"
																				class="mcnImage">
																...
																<tbody>
																	<tr>
																		...
																		<td valign="top" class="mcnTextContent"
																			...
																			<h3 style="text-align: center;">Contacto
																			</h3>

																			<p>Un posible cliente envio un mensaje por
																				el formulario de
																				contacto<strong>.</strong><br>
																				<br>
																				A continuación te mostramos la
																				información que el usuario dejó:</p>

																			<ul>
																				<li style="text-align: left;">Nombre: {{$name}}</li>
																				<li style="text-align: left;">Email: {{$email}}</li>
																				<li style="text-align: left;">Teléfono: {{$phone}}</li>
